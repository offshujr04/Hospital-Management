...
class Hospital:
    def __init__(self, root):
        ...
        #Variables to get data from txt field
        self.nameoftabs=StringVar()
        self.ref=StringVar()
        self.dose=StringVar()
        self.nooftabs=StringVar()
        self.lot=StringVar()
        ...
        comNametablet = ttk.Combobox(
            DataframeLeft, font="Arial 12 bold",textvariable=self.nameoftabs ,width=30)  # Entry field
        ...
        txtref = Entry(DataframeLeft, font="Arial 12 bold",textvariable=self.ref,width=35)  # Entry field
        ...
        txtdose = Entry(DataframeLeft, font="Arial 12 bold",
                        textvariable=self.dose,width=35)  # Entry field
        ...
        txtnumtabs = Entry(DataframeLeft, font="Arial 12 bold",
                           textvariable=self.nooftabs,width=35)  # Entry field
        ...
        txtlot = Entry(DataframeLeft, font="Arial 12 bold",
                       textvariable=self.lot,width=35)  # Entry field
        ...
        txtissue = Entry(DataframeLeft, font="Arial 12 bold",
                         textvariable=self.issue,width=35)  # Entry field
        ...
        txtend = Entry(DataframeLeft, font="Arial 12 bold",
                       textvariable=self.exp,width=35)  # Entry field
        ...
        txtdailydose = Entry(
            DataframeLeft, font="Arial 12 bold",textvariable=self.daily, width=35)  # Entry field
        ...
        txteffect = Entry(DataframeLeft, font="Arial 12 bold",
                          textvariable=self.effect,width=35)  # Entry field
        ...
        txtinfo = Entry(DataframeLeft, font="Arial 12 bold",
                        textvariable=self.info,width=35)  # Entry field
        ...
        txtbloodp = Entry(DataframeLeft, font="Arial 12 bold",
                          textvariable=self.bloodp,width=35)  # Entry field
        ...
        txtid = Entry(DataframeLeft, font="Arial 12 bold",
                      textvariable=self.id,width=35)  # Entry field
        ...
        txtname = Entry(DataframeLeft, font="Arial 12 bold",
                        textvariable=self.name,width=35)  # Entry field
        ...
        txtnhs = Entry(DataframeLeft, font="Arial 12 bold",
                       textvariable=self.nhs,width=35)  # Entry field
        ...
        txtdob = Entry(DataframeLeft, font="Arial 12 bold",
                       textvariable=self.dob,width=35)  # Entry field
        ...
        txtlocation = Entry(
            DataframeLeft, font="Arial 12 bold", textvariable=self.address,width=35)  # Entry field
